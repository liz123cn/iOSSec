...
- (unsigned long)GetContentLen:(id)arg1;
- (id)GetRedirectUrl:(id)arg1;
- (unsigned long)GetRetCode:(id)arg1;
- (void)HandleHttpResp:(id)arg1;
- (void)InitPrtl:(id)arg1;
- (BOOL)IsNoCache:(id)arg1;
- (id)PackHttpHeader;
- (void)ResetChannel;
- (BOOL)Start;
- (void)Stop;
...
- (void)onSocket:(id)arg1 didReadPartialDataOfLength:(unsigned int)arg2 tag:(long)arg3;
