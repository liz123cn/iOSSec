...
@property(nonatomic) BOOL bPositioning; // @synthesize bPositioning=_bPositioning;
- (BOOL)becomeFirstResponder;
- (void)dealloc;
@property(nonatomic) __weak id <WCShareCardCommentInputToolViewDelegate> delegate; // @synthesize delegate=_delegate;
- (id)getText;
