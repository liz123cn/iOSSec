...
@property(nonatomic) BOOL bAddBorder; // @synthesize bAddBorder=_bAddBorder;
...
@property(nonatomic) BOOL isShowCertIcon; // @synthesize isShowCertIcon=_isShowCertIcon;
- (void)layoutSubviews;
@property(nonatomic) unsigned long m_conerSize; // @synthesize m_conerSize;
...
@property(nonatomic) int shadowWidth; // @synthesize shadowWidth=_shadowWidth;
