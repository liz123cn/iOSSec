...
- (id)initWithFrame:(struct CGRect)arg1 withConsumedInfo:(id)arg2 consumedCardID:(id)arg3 consumedBoxId:(id)arg4 subscribeAppUserName:(id)arg5 subscribeWording:(id)arg6 retMsg:(id)arg7;
