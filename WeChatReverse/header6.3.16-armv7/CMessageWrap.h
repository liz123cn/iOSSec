...
@interface CMessageWrap : MMObject <IAppMsgPathMgr, ISysNewXmlMsgExtendOperation, IMsgExtendOperation, NSCopying>
{
    ...
    unsigned int _macMsgSourceType;
}
...
@property(nonatomic) unsigned int macMsgSourceType; // @synthesize macMsgSourceType=_macMsgSourceType;
