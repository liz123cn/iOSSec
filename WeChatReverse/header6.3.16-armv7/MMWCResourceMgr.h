...
- (BOOL)hasWebCacheFeatureForDomain:(id)arg1;
- (id)init;
- (BOOL)isPageForResUrl:(id)arg1 mainUrl:(id)arg2;
- (BOOL)isPublicResUrl:(id)arg1;
- (BOOL)isSameCrc32:(unsigned long)arg1 ofConfigId:(id)arg2;
- (void)loadWebcacheDomainList;
- (void)makeUrlInfoFrom:(id)arg1 to:(id)arg2 withPrefix:(id)arg3 isPage:(BOOL)arg4;
- (void)onBatchDownloadFinish:(BOOL)arg1 errMsgList:(id)arg2 batchTask:(id)arg3;
- (void)onBatchSaveHandler:(id)arg1 finish:(BOOL)arg2 failedUrlInfoList:(id)arg3 errMsgList:(id)arg4 handlerId:(unsigned long)arg5 configInfo:(id)arg6;
...
- (BOOL)savePageResourceIfNeed:(id)arg1 resUrl:(id)arg2 resData:(id)arg3;
