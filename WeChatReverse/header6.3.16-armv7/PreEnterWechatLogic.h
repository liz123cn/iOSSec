...
@class InitLogicController, MMLoadingView, MMUIWindow, NSMutableArray, NSString, NSURL, PasswordLogic, ShowRatingAchive, UIAlertController, WCAccountBindPhoneControlLogic, WCUIAlertView, WhatsnewViewController;
