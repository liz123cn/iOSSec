...
- (void)showSightWindowWithBottomMask:(id)arg1 andTopMask:(id)arg2 maskAlpha:(float)arg3 iconCenter:(struct CGPoint)arg4 byViewController:(id)arg5;
...
- (unsigned long)startRecording:(struct CGSize)arg1 bitrate:(float)arg2 atCaptureScene:(unsigned int)arg3;
