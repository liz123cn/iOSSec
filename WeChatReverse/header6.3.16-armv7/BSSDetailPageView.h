...
@property(nonatomic) unsigned long friendScene; // @synthesize friendScene=_friendScene;
...
- (id)initBSSDetailPageViewWithResultType:(int)arg1 andBusinessType:(unsigned long long)arg2 andKeyword:(id)arg3 andLocation:(id)arg4 andParentVC:(id)arg5 andFriendScene:(unsigned long)arg6 andEntrySrc:(unsigned long)arg7;
- (void)initBackBtn;
- (void)initFooterView;
