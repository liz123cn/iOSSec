...
- (id)getLogoName;
- (float)getRealHeight;
- (void)initMemberCardContentViewWithStartY:(float)arg1;
- (void)initView;
- (id)initWithViewWidth:(float)arg1 withCardSourceData:(id)arg2 isShareCard:(BOOL)arg3 cardStatus:(int)arg4 isNeedHideAcceptBtn:(BOOL)arg5 delegate:(id)arg6;
