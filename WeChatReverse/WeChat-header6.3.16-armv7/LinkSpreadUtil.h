...
+ (void)logLinkSpead:(id)arg1 currId:(id)arg2 preUserName:(id)arg3 preChatUserName:(id)arg4 currUrl:(id)arg5 preMsgIndex:(unsigned long)arg6 getA8KeyScene:(unsigned long)arg7 referUrl:(id)arg8 statExtStr:(id)arg9;
+ (void)logViewWebView:(id)arg1 getA8KeyScene:(unsigned long)arg2 enterTime:(unsigned long)arg3 adId:(id)arg4 appId:(id)arg5 referUrl:(id)arg6;
