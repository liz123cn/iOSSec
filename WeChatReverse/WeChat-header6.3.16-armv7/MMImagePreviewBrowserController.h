...
- (void).cxx_destruct;
- (unsigned long)IndexFromSelectedAssetInfosOfPageIndex:(unsigned long)arg1;
...
- (void)OnSend:(id)arg1;
- (void)baseLoadImage:(id)arg1 isCurrentImage:(BOOL)arg2;
- (void)clearImagePool;
...
- (void)getThumbImageAtIndex:(unsigned long)arg1;
...
- (void)setBottomAndTopBarHidden:(BOOL)arg1;
- (void)setCreateTimeAndLocationWithAnimation:(id)arg1;
- (void)setCreateTimeInMiddleLocation:(id)arg1;
- (void)setOriginImageButtonCheck:(BOOL)arg1 SelectedButton:(BOOL)arg2;
- (void)setPageAtIndex:(unsigned long)arg1;
