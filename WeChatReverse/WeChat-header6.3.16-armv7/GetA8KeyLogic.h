...
- (void)GetA8Key:(id)arg1 Scene:(unsigned long)arg2 subScene:(unsigned long)arg3;
- (void)MessageReturn:(id)arg1 Event:(unsigned long)arg2;
- (void)OnGetA8Key:(id)arg1;
- (void)OnGetRemoteProductItem:(id)arg1 QRCodeUrl:(id)arg2 Error:(int)arg3;
- (void)alertView:(id)arg1 clickedButtonAtIndex:(int)arg2;
- (void)dealloc;
- (void)doSearchContact:(id)arg1 FromScene:(unsigned long)arg2 SearchScene:(unsigned long)arg3;
- (void)doSearchContact:(id)arg1 SearchScene:(unsigned long)arg2;
