...
@interface WCDataBaseItem : NSObject <PBCoding>
{
    int m_type;
    Class m_cls;
    basic_string_7d00a7a9 m_name;
    basic_string_7d00a7a9 m_default;
    basic_string_7d00a7a9 m_constraint;
    SEL m_getter;
    SEL m_setter;
    id m_blockGet;
    id m_blockSet;
...
@property(readonly, nonatomic) basic_string_7d00a7a9 m_constraint; // @synthesize m_constraint;
@property(readonly, nonatomic) basic_string_7d00a7a9 m_default; // @synthesize m_default;
@property(readonly, nonatomic) SEL m_getter; // @synthesize m_getter;
@property(readonly, nonatomic) basic_string_7d00a7a9 m_name; // @synthesize m_name;
