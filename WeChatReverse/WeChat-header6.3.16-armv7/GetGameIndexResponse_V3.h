...
@class AppStoreControl, BaseResponse, FeedBackEntrance, GameRecommend, IndexGift, Installed, LibraryEntrance, NSString, NewHot, RecentPlayInfo, TopRecommendBanner;
