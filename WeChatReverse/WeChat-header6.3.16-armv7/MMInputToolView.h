...
- (BOOL)isPointInRecordGarbageView:(struct CGPoint)arg1;
...
- (void)onDragTableViewEnd:(float)arg1;
...
- (void)onInputToolViewBarBottomChanged:(float)arg1;
- (void)onInputToolViewBarTopChanged:(float)arg1;
