...
@class BakChatUploadPackageHelperStruct, ChatMigrationBackupChatDBHelper, NSMutableSet, NSRecursiveLock;
...
@interface ChatMigrationBackupChatFileHelper : NSObject
{
    ...
    unsigned int m_totalAddMsgToPackageCount;
    BOOL m_bGetNewMessageFinished;
    unsigned int m_noExistDiscardCount;
    unsigned int m_noKnownErrorDiscardCount;
}
