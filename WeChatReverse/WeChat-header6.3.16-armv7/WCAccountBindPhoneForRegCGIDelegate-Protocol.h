...
- (void)onCheckLoginVerifyCode:(AccountErrorInfo *)arg1 ticket:(NSString *)arg2 controlShowFlag:(unsigned long)arg3 userName:(NSString *)arg4 password:(NSString *)arg5 StyleKeyValue:(NSDictionary *)arg6;
...
- (void)onCheckRegVerifyCode:(AccountErrorInfo *)arg1 ticket:(NSString *)arg2 controlShowFlag:(unsigned long)arg3 userName:(NSString *)arg4 password:(NSString *)arg5 StyleKeyValue:(NSDictionary *)arg6;
