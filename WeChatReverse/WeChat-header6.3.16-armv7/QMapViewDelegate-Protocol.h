...
- (void)mapView:(QMapView *)arg1 annotationView:(QAnnotationView *)arg2 didChangeDragState:(unsigned int)arg3 fromOldState:(unsigned int)arg4;
...
- (void)mapView:(QMapView *)arg1 didUpdateUserLocation:(QUserLocation *)arg2 updatingLocation:(BOOL)arg3;
